    ...
    <div className="relative bg-gray-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 relative z-10 text-center flex flex-col items-center">
        <span className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-full text-white/90 text-[10px] font-bold uppercase tracking-widest mb-6 backdrop-blur-md border border-white/20">
          <Star className="w-3 h-3 text-yellow-400" /> Nền Tảng Đấu Giá Số 1
        </span>
        <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight mb-6">
          Khám Phá Vật Phẩm <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-purple-400">Độc Quyền</span>
        </h1>
        <p className="text-lg text-gray-400 max-w-2xl mx-auto font-medium mb-12">
          Tham gia cùng hàng ngàn nhà sưu tập trên toàn thế giới. Đấu giá những món đồ vật lý được kiểm định từ đồng hồ xa xỉ đến sneaker giới hạn.
        </p>
        ...
        <div className="w-full max-w-2xl relative group">
          ...
          <input
            ...
            placeholder="Tìm kiếm theo tên phiên, từ khóa, hoặc thương hiệu..."
          />
        </div>
      </div>
    </div>
